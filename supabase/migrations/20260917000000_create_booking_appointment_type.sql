-- Garante que a versão da create_booking que persiste appointment_type e
-- duration_minutes (preço/duração da manutenção) esteja registrada no repositório.
-- O preço e a duração aplicados são calculados no banco: se appointment_type =
-- 'maintenance', usa maintenance_promotional_price/maintenance_price e
-- maintenance_duration_minutes; senão usa os valores normais do serviço.
